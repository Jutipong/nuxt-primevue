        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            <div
                ...
                <a class="flex align-items-center" href="#"> <img :src="logoUrl" alt="Sakai Logo" height="50"
                        class="mr-0 lg:mr-2" /><span class="text-900 font-medium text-2xl line-height-3 mr-8">SAKAI</span>
                </a>
                ...
                <div class="align-items-center surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2"
                    ...
                    <ul
                        ...
                        <li>
                            <a v-ripple @click="smoothScroll('#hero')"
                                class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple">
                                <span>Home</span>
                            </a>
                        </li>
                        <li>
                            <a v-ripple @click="smoothScroll('#features')"
                                class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple">
                                <span>Features</span>
                            </a>
                        </li>
                        <li>
                            <a v-ripple @click="smoothScroll('#highlights')"
                                class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple">
                                <span>Highlights</span>
                            </a>
                        </li>
                        <li>
                            <a v-ripple @click="smoothScroll('#pricing')"
                                class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple">
                                <span>Pricing</span>
                            </a>
                        </li>
