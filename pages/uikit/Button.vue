...
<template>
  <div class="grid">
    <div class="col-12 md:col-6">
      ...
      <div class="card">
        <h5>SplitButton</h5>
        <SplitButton label="Save" :model="items" class="mb-2 mr-2" />
        <SplitButton label="Save" :model="items" severity="secondary" class="mb-2 mr-2" />
        <SplitButton label="Save" :model="items" severity="success" class="mb-2 mr-2" />
        <SplitButton label="Save" :model="items" severity="info" class="mb-2 mr-2" />
        <SplitButton label="Save" :model="items" severity="warning" class="mb-2 mr-2" />
        <SplitButton label="Save" :model="items" severity="help" class="mb-2 mr-2" />
        <SplitButton label="Save" :model="items" severity="danger" class="mb-2 mr-2" />
        <SplitButton label="Save" :model="items" severity="contrast" class="mb-2 mr-2" />
      </div>
    ...
    <div class="col-12 md:col-6">
      ...
      <div class="card">
        <h5>Loading</h5>
        <Button
          type="button" class="mr-2 mb-2" label="Search" icon="pi pi-search" :loading="loading[0]"
          @click="load(0)"
        />
        <Button
          type="button" class="mr-2 mb-2" label="Search" icon="pi pi-search" icon-pos="right"
